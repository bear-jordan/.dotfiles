...
wk.register({
    ...
    o = {
        ...
        v = { "<cmd>ObsidianFollowLink vsplit<cr>", "follow |" },
        h = { "<cmd>ObsidianFollowLink hsplit<cr>", "follow -" },
        b = { "<cmd>ObsidianBacklink<cr>", "backlinks" },
        t = { "<cmd>ObsidianTemplate<cr>", "template" },
        s = { "<cmd>ObsidianSearch<cr>", "search" },
        l = { "<cmd>ObsidianLink<cr>", "link" },
        e = { "<cmd>ObsidianExtractNote<cr>", "extract" },
        r = { "<cmd>ObsidianRename<cr>", "rename" },
        g = { "<cmd>ObsidianToggleCheckbox<cr>", "toggle" },
    },
}, { prefix = "<leader>" })
